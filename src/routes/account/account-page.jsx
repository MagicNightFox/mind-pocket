...
const AccountPage = () => {
  ...
  const getLangPref = (userLang) => {
    switch(userLang){
      case "en": return {title: t.AccountPage.English, value: "en"}
      case "cs": return {title: t.AccountPage.Czech, value: "cs"}
    }
  }
  ...
  return <Box>
    ...
    <Container maxWidth="100%" sx={{display: "flex", flexDirection: "column", gap: "16px"}}>
      ...
      <Autocomplete
        options={[{title: t.AccountPage.English, value: "en"}, {title: t.AccountPage.Czech, value: "cs"}]}
